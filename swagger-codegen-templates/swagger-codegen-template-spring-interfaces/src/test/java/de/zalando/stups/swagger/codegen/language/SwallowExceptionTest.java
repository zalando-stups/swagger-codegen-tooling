...
public class SwallowExceptionTest {
    ...
    public void testGenerateWithException() throws CodegenerationException {
    ...
    private File getApiYamlFile() {
        return new File(getClass().getResource("/swallowException.yaml").getFile());
    }
